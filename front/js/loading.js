...
function DisplayCyclists(cycliste){
    for(let i = 0; i < cycliste.length; i++){
		$('#tableau_coureurs').append('<tr><td>' + cycliste[i].nom + '</td><td >' + cycliste[i].prenom + '</td><td>null</td><td>null</td><td>' + cycliste[i].num_licence + '</td><td><a href=#><i class="fas fa-cogs"></i></a></td></tr>');
	}

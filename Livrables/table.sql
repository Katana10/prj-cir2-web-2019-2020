...
('  pc@uti.fr', 'PREVOT', 'Christophe', 55654078, NULL, 1, 'CC BOURG BLANC', 29061, 'Super V�t�ran', '3eme  cat'),
('ac@fgt.com', 'ABIVEN', 'Christophe', 55602886, NULL, NULL, 'CC BOURG BLANC', 29061, 'S�nior', '2eme  cat'),
('ac@hgt.fr', 'ARNAUD', 'C�dric', 55544762, NULL, 1, 'AC GOUESNOU', 29061, 'S�nior', '2eme  cat'),
('cl@team.gt', 'COLLET', 'Louis', 695576, NULL, NULL, 'ABC PLOUESCAT', 29061, 'V�t�ran', '2eme  cat'),
('dj@taem.com', 'DUDORET', 'Jo�l', 55654078, NULL, 1, 'ABC PLOUESCAT', 29185, 'S�nior', '1ere cat'),
('kc@pli.fr', 'KERMORGANT', 'Cyril', 695582, NULL, NULL, 'SAINT RENAN.I.V', 29260, 'V�t�ran', '3eme  cat'),
('lb@team.fr', 'LUCAS', 'Benjamin', 267406, NULL, NULL, 'ABC PLOUESCAT', 29185, 'Ancien', '1ere cat'),
('lg@team.fr', 'LE GLEAU', 'Alain', 55477384, NULL, 1, 'AC GOUESNOU', 29015, 'S�nior', '1ere cat'),
('md@ilg.com', 'MOYSAN', 'David', 55537517, NULL, 1, 'ABC PLOUESCAT', 29015, 'Super V�t�ran', '2eme  cat'),
('my@trez.fr', 'MEVEL', 'Yann', 369676, NULL, 1, 'AC GOUESNOU', 29061, 'V�t�ran', '1ere cat'),
('sjm@rest.ft', 'SALIOU', 'Jean Marc', 135645, NULL, 1, 'AC GOUESNOU', 29185, 'V�t�ran', '2eme  cat'),
('tb@opf.com', 'TIRILLY', 'Bertrand', 674243, NULL, NULL, 'SAINT RENAN.I.V', 29260, 'V�t�ran', '5eme  cat');
...
(1, 'Course Cycliste FSGT à GOUESNOU (29)', 'AC GOUESNOU', '2019-05-20', 12, 87.6, 50, 7.3);
